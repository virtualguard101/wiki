"""
Source: [Coursera: Machine Learning](https://www.coursera.org/learn/machine-learning)-Optional Lab1-3
Also can be found on Github: [lab_utils_uni.py](https://github.com/greyhatguy007/Machine-Learning-Specialization-Coursera/blob/main/C1%20-%20Supervised%20Machine%20Learning%20-%20Regression%20and%20Classification/week1/Optional%20Labs/lab_utils_uni.py)
"""
...
from src.lab_utils_common import compute_cost
from src.lab_utils_common import dlblue, dlorange, dldarkred, dlmagenta, dlpurple, dlcolors
...
class plt_update_onclick:
    def init(self, fig, ax, x_train,y_train, dyn_items):
        self.fig = fig
        self.ax = ax
