...
- **在[构造函数](C++类%20&%20模板.md#构造函数Constructor)中获取资源**：当对象被创建时，它的构造函数负责获取所需的资源。

- **在[析构函数](C++类%20&%20模板.md#析构函数Destructor)中释放资源**：当对象被销毁时，它的析构函数负责释放之前获取的资源。
...
!!! note
    ...
    ![](assets/11-smart_pointer-RAII/share_pointer.png)
