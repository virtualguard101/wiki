...
<div class="responsive-video-container">
    <iframe src="https://player.bilibili.com/player.html?bvid=BV1RtezzTEz9&autoplay=0"
    scrolling="no" 
    border="0" 
    frameborder="no" 
    framespacing="0" 
...
基于树的递归特性，在确定二叉树的根节点后，可以**递归**地构造其左右子树。

### 前序+中序

![](assets/binary-traversal/pre_in.jpg)

![](assets/binary-traversal/pre_in_1.jpg)

### 后序+中序

![](assets/binary-traversal/post_in.jpg)

![](assets/binary-traversal/post_in_1.jpg)

### 层序+中序

![](assets/binary-traversal/level_in.jpg)

![](assets/binary-traversal/level_in_1.jpg)
