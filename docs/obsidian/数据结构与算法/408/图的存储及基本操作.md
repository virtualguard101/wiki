...
![](assets/graph-store-operation/adjacency_matrix.jpg)
...
邻接矩阵在稀疏图上太空, 浪费空间. **邻接表**(*Adjacency List*) 改成: 顶点表用[顺序表](线性表的顺序表示.md), 每个顶点挂一条[单链表](线性表的链式表示.md)记下它的邻接点. 和树的[孩子表示法](树与森林.md#孩子表示法)同一思路.

![](assets/graph-store-operation/adjacency_table.jpg)
...
![](assets/graph-store-operation/orthogonal_linked_list.jpg)
...
![](assets/graph-store-operation/mul_adjacency_table.jpg)
