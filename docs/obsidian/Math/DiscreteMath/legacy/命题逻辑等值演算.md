...
设 $A$、$B$ 为两个命题公式，若 $A$ 和 $B$ 构成的等价式 $A \leftrightarrow B$ 为[重言式](命题逻辑的基本概念.md#重言式矛盾式)，则称 $A$ 和 $B$ 等值，记作 $A \Leftrightarrow B$。
...
- [**德摩根律**](../集合%20&%20数学符号与逻辑命题.md#否定运算)
...
- [*排中律*](../集合%20&%20数学符号与逻辑命题.md#逻辑连接词与命题形式)
...
- 简单[析取](命题逻辑的基本概念.md#命题联结词)式: 由有限个文字构成的析取式，如 $P \vee Q \vee \neg R$

- 简单[合取](命题逻辑的基本概念.md#命题联结词)式: 由有限个文字构成的合取式，如 $P \wedge Q \wedge \neg R$
