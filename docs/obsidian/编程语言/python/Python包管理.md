...
包管理工具用于管理项目的依赖项，包括安装、升级、卸载等操作。我目前主要使用的是[Astral uv](../../Tools/Astral%20uv.md)。
...
[虚拟环境](Python虚拟环境.md)是包管理的核心机制之一，能解决依赖冲突问题。这里我同样主要使用 [Astral uv](../../Tools/Astral%20uv.md) 进行虚拟环境管理。
