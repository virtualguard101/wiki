...
![双端队列](../../../assets/dsa.assets/ds/linear/deque/deque_operations.png)
...
![双端队列-顺序结构](../../../assets/dsa.assets/ds/linear/deque/array_deque_step1.png)

基于数组的实现，只需在循环队列的基础上在头尾分别添加插入与删除操作即可：
...
![双端队列-链式结构](../../../assets/dsa.assets/ds/linear/deque/linkedlist_deque_step1.png)
