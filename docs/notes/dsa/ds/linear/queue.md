...
![循环队列](../../../assets/dsa.assets/ds/linear/queue/cir_queue.png)
...
- 一是设置一个标志变量来区分空与满两种情况，这种方法相对简单——可以通过判断队列中是否有元素来改变`flag`的值:
    ...
    ![队列空](../../../assets/dsa.assets/ds/linear/queue/cir_queue_1.png)

    ![队列满](../../../assets/dsa.assets/ds/linear/queue/cir_queue_2.png)
...
- 二是为队列满的情况设置一种有别于队列空的形式:
    ...
    - 当队列满时，`rear`从左侧靠近`front`，但不会等于`front`，==即在`front`左侧保留一个空位==:
        ...
        ![队列满-无标识值](../../../assets/dsa.assets/ds/linear/queue/cir_queue_3.png)
...
![链队列](../../../assets/dsa.assets/ds/linear/queue/linked_queue.png)
