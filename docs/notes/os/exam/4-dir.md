...
线性列表可以是[线性表](../../dsa/ds/linear/array.md)或[链表](../../dsa/ds/linear/linked-list.md)，相关操作的时间复杂度与之相关。
...
基于[文件索引节点](4-file-sys-overview.md#索引节点)的链接也叫**硬链接**，它将文件的物理地址和属性等信息不再存放在目录项中，而是存放在索引节点里，在目录项中只设置文件名及指向相应索引节点的指针。
