...
- 按设备的共享属性分类
    ...
    - 虚拟设备: 通过[SPOOLing（假脱机）技术](https://zh.wikipedia.org/wiki/%E5%81%87%E8%84%B1%E6%9C%BA)将独占设备改造为共享设备，将一个物理设备虚拟为多个逻辑设备，从而将设备同时分配给多个进程[^1]。
...
[^1]: [Spooling in Operating System | GeeksforGeeks](https://www.geeksforgeeks.org/operating-systems/spooling-in-operating-system/)