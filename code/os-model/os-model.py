...
class OS:
    ...
    class Process:
        ...
        Attributes:
            ...
            retval: The return value of the last system call, which is set by the OS's main loop.
        '''

        def __init__(self, func, *args):
            """`func` should be a generator function. Calling func(*args) returns a generator object.
            """
        ...
        def step(self):
            '''Resume the process with OS-written return value, until the next system call is issued.
            '''
